...
print("method call: " + str(time_method))
...
print("func call from method: " + str(time_func_from_method))
...
print("pure func call: " + str(time_func_pure))
...
for input in rand_inputs:
    ...
    output = a*b
end_time = time.time()
time_no_calls = end_time-start_time
print("no calls: " + str(time_no_calls))
...
print(as_perc(time_method, time_no_calls))
